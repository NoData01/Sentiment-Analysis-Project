# -*- coding: utf-8 -*-
"""Sentiment_Articles_Analysis.py
...
#%% Discussion
# Although we have achieve 75% accuracy, the result is overfitting.
# Increasing the data ,adding more layers, dropout, increasing the number of 
# nodes might help in preventing the overfitting and can improve the model.
